const donneesTest = [
  ...
  },
  {
    ...
    description:
      "Un homme doit choisir entre son amour pour une femme et aider son mari à échapper aux nazis.",
    annee: "1942",
  ...
  },
  {
    ...
    description:
      "Un secrétaire en fuite se retrouve dans un motel étrange tenu par un homme obsédé par sa mère.",
    annee: "1960",
  ...
  },
  {
    ...
    description:
      "Luke Skywalker se joint à la Rébellion pour sauver la princesse Leia des griffes de Dark Vador.",
    annee: "1977",
  ...
  },
  {
    ...
    description:
      "Un adolescent voyage dans le temps jusqu'aux années 1950 où ses parents se sont rencontrés.",
    annee: "1985",
  ...
  },
  {
    ...
    description:
      "Un parc à thème peuplé de dinosaures clonés tourne mal après une panne de courant.",
    annee: "1993",
    realisation: "Steven Spielberg",
  ...
  },
  {
    ...
    description:
      "Un homme découvre que sa vie est en réalité une émission de télévision.",
    annee: "1998",
  ...
  },
  {
    ...
    genres: ["Action", "Aventure", "Fantaisie"],
    description:
      "Un marine paraplégique est envoyé sur la lune Pandora où il tombe amoureux d'une habitante.",
    annee: "2009",
  ...
  },
  {
    ...
    description:
      "Les aventures d'un concierge d'hôtel légendaire et de son protégé.",
    annee: "2014",
  ...
  },
  {
    ...
    description:
      "Un musicien et une actrice en herbe tombent amoureux à Los Angeles.",
    annee: "2016",
